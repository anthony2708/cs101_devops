...
import importedCode from '/src/content/docs/reference/golang/code/src/web/main.go?raw';
import newCode from '/src/content/docs/reference/golang/code/src/web/printf.go?raw';
...
_Bạn nên thay thế tên hàm ```printf``` thành ```main``` trước khi chạy đoạn mã nguồn phía dưới._

:::

<Code code={newCode} lang="go" title="src/printf.go" />
